...
const FAQ_ITEMS = [
  ...
  {
    q: 'How is Synapnode different from ChatGPT?',
    a: "ChatGPT is a general assistant. Synapnode is trained specifically on A-Level Maths curricula — it knows AQA, Edexcel, OCR and WJEC mark schemes, shows working exactly how examiners expect it, tracks your progress over time, and won't hallucinate a GCSE answer when you ask an A-Level question.",
  },
  {
    q: 'Which exam boards does Synapnode cover?',
  ...
  {
    q: 'Can I use Synapnode for both Year 12 and Year 13?',
  ...
  },
  {
    ...
    a: 'Synapnode tracks your weak spots and surfaces them through the spaced-repetition flashcard system. The more you practice, the smarter your personalised revision plan becomes.',
  },
  {
    q: 'Is Synapnode suitable if I have ADHD, dyslexia, or dyscalculia?',
  ...
  },
  {
    ...
    a: '£35/month (about £1.17/day), or £276/year (£23/month, saving 34%). For context, the average A-Level Maths tutor on Tutorful charges £41.59/hour — Synapnode gives you unlimited 24/7 access for less than the cost of a single tutoring session per month.',
  },
  {
  ...
  {
    q: 'Can my school or college get Synapnode?',
